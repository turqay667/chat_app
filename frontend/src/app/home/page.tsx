...
setShowSidebar={setShowSidebar} blocked={blocked} setBlocked={setBlocked} users={users} 
...
showChat===true ? <>
 ...
 {/* style={{backgroundColor:theme==='dark'? '#262e35' : '#ffffff'}} */}
        ...
        selectedUser  && (   
        <>
<Header theme={theme} muted={muted} setMuted={setMuted} selectedUser={selectedUser}  setMessages={setMessages} onlineUsers={onlineUsers} setShowSidebar={setShowSidebar} setShowChat={setShowChat}/> 
<div className="conversation-body overflow-auto text-center" >
<Messages messages={messages} user={user}    theme={theme} setMessages={setMessages} setAllMessages={setAllMessages}/>
{loading ? <></> : <></>}
</div>
